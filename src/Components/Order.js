...
class Order extends PureComponent {
    ...
    handleSubmit = (event) => {
        ...
        if (this.state.name !== '' && this.state.data.product.item > 0) {
            const orders = localStorage.getItem('orders') == null
                ? []
            ...
            if (keyname === 'product') {
                    ...
                    return {
                        ...
                        data: {
                            ...
                            product: {
                                ...
                                item: type !== 'add' && prevState.data.product.item > 0
                                    ? prevState.data.product.item - 1
                                    : prevState.data.product.item + 1
                            }
                        },
                        total: type !== 'add' && prevState.data.product.item > 0
                            ? prevState.total - prevState.data.product.price
                            : prevState.total + prevState.data.product.price
                    }
                }
            } else if (keyname === 'ingradients') {
                ...
                if (type === 'add' && prevState.data.ingradients[obj.id - 1].item >= 1) {
                    ...
                    return {
                        ...
                        data: {
                            ...
                            ingradients: [
                                ...prevState
                                    ...
                                    .ingradients
                                    .slice(0, obj.id - 1), {
                                    ...prevState.data.ingradients[obj.id - 1],
                                    item: type !== 'add' && prevState.data.ingradients[obj.id - 1].item > 0
                                        ? prevState.data.ingradients[obj.id - 1].item - 1
                                        : prevState.data.ingradients[obj.id - 1].item + 1
                                },
                                ...prevState
                                    .data
                        ...
                        total: type !== 'add' && prevState.data.ingradients[obj.id - 1].item > 0
                            ? prevState.total - prevState.data.ingradients[obj.id - 1].price
                            : prevState.total + prevState.data.ingradients[obj.id - 1].price
                    }
                }
            }
    ...
    render() {
        ...
        const ingradientsview = !_.isEmpty(this.state.data.ingradients) && this
            ...
            .data
            .ingradients
            .map((item, i) => <Item data={item} updateItem={this.updateItem} key={i} keyname='ingradients'/>);
        return (
            <React.Fragment>
                <Navbar/>
